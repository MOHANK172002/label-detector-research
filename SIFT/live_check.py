...
def draw_4panel(master_gray, aligned, diff, diff_mask,
    ...
    cv2.putText(bar, f"SSIM: {ssim_score:.3f}",
                (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, ssim_col, 2)
    cv2.putText(bar, f"Fine: {fine_pct:.1f}%",
                (210, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, fine_col, 2)
    cv2.putText(bar, f"Coarse: {coarse_pct:.1f}%",
                (390, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, coarse_col, 2)
    cv2.putText(bar, f"->  {result}",
                (590, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.85, color, 2)
    cv2.putText(bar, "Fine=text/print   Coarse=structure/hologram position",
                (10, 88), cv2.FONT_HERSHEY_SIMPLEX, 0.42, (160, 160, 160), 1)
